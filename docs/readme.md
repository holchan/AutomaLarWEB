...
## Topic: Interior Depth Mapping Technique

This section details the files related to the Interior Depth Mapping ('3D Printing') technique used in the hero section of the landing page. This technique combines environment maps and orthographically captured depth/color information to create the illusion of depth.

### Files:

- [03_PAGE_SPECIFICATIONS/00_LANDING_PAGE.mdx](03_PAGE_SPECIFICATIONS/00_LANDING_PAGE.mdx): Describes the use of the technique in the hero section.
- [04_ART_WORKSHOP/00_HERO_SCENE_SCREENPLAY.mdx](04_ART_WORKSHOP/00_HERO_SCENE_SCREENPLAY.mdx): Specifies the asset requirements for the technique.
- [05_TECHNICAL_IMPLEMENTATION/06_3D_IMPLEMENTATION/05_INTERIOR_DEPTH_MAPPING.mdx](05_TECHNICAL_IMPLEMENTATION/06_3D_IMPLEMENTATION/05_INTERIOR_DEPTH_MAPPING.mdx): Details the implementation of the technique.
