...
async def test_parse_simple_function_file(parser: PythonParser, tmp_path: Path, run_parser_and_save_output):
    ...
    assert chunk0_meta.get("chunk_of", "").startswith("test_file_id_"), "Chunk parent ID missing or invalid"
    ...
    assert dep_os.get("text_content") == "import os"
    ...
    assert dep_log.get("text_content") == "import logging"
